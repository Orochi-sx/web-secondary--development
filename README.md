...
| src/components | 存放填报二开所需要的六个编辑页面 |
| src/App.vue | 是插件组件的主文件，用于开发插件的 vue 组件。                                                                                       |
| src/index.css | 全局的公共样式文件                                                                          |
| main.js | 所有文件入口，可以在这引入所有配置文件，插件等 |
...
| type    | 开发插件类型，主要包括如下类型：<br/>● reporting：填报设计   |
